...
**TAB 5 — config and something else**
- start date set 
- all the necessary config options
...
Output the complete nextjs mobile first web app. Then:

```
BUILD COMPLETE
──────────────
Data embedded: 150 projects · [N] questions · [N] skills · 10 syllabi · [N] courses
Tabs: 5 (Today, Track and vault, Learn, Log, config)
...
6. **Payable skills are parallel, not primary.** They never replace tech work. They are the daily WORK that compounds over months.
