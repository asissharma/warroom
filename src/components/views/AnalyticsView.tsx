...
import { QUESTIONS, PROJECTS, TECH_SPINE, BASIC_SKILLS, PAYABLE_SKILLS } from '@/data/learningData';
import RadarChart from '../RadarChart';

interface Props { state: AppState; }

export default function AnalyticsView({ state }: Props) {
    const masterTotal = QUESTIONS.length + PROJECTS.length + TECH_SPINE.length + BASIC_SKILLS.length + PAYABLE_SKILLS.length;
